...
![](DevOps/Cloud/Cloud%20Dasar/Image/7.png)
...
Jadi, dapat ![](DevOps/Cloud/Cloud%20Dasar/Image/6.png)zdisederhanakan bahwa _virtual private gateway_ adalah komponen yang memungkinkan traffic internet yang terlindungi masuk ke dalam VPC. Silakan amati contoh arsitektur berikut:

![](DevOps/Cloud/Cloud%20Dasar/Image/6.png)
...
Oh, tidak! Sayangnya, sekarang timbul masalah baru terhadap kasus di atas, meskipun Anda memiliki perlindungan yang ekstra. Apa itu? Anda masih menggunakan jalanan yang sama dengan pelanggan lain. Walhasil, pastinya ia akan rentan terhadap kemacetan atau perlambatan lalu lintas.

Hal yang sama pun berlaku untuk koneksi VPN. Memang betul koneksi VPN bersifat pribadi dan dienkripsi, tetapi faktanya ia masih menggunakan koneksi internet reguler dengan _bandwidth_ (jumlah maksimum data yang dapat dikirim) yang terbagi kepada banyak pengguna internet lainnya.
...
AWS Direct Connect memungkinkan Anda untuk membuat koneksi fiber yang privat dan terdedikasi sepenuhnya antara data center Anda dan VPC. Untuk membangun koneksi tersebut, Anda perlu berpartner dengan mitra Direct Connect yang tersedia di wilayah Anda.
